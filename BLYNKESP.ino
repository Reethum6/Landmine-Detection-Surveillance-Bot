...
<tr><td align="center">
<button class="button" onmousedown="toggleCheckbox(’Left</button></td><td align="center">
</td><td align="center">
<button class="button" onmousedown=
"toggleCheckbox(’right’);" ontouchstart="toggleCheckbox(’>Right</
button>
</td></tr>
<tr><td colspan="3" align="center">
<button class="button" onmousedown="toggleCheckbox(’down’);" ontouchstart="toggleCheckbox(’down’);">Down</</td></tr>
</table>
<script>
...
httpd_resp_set_hdr(req, "Access-Control-
Allow-Origin", "*");
